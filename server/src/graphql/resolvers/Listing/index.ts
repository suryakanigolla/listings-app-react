...
export const ListingResolvers: IResolvers = {
  ...
  Mutation: {
    hostListing: async (
      ...
      const insertedListing: Listing = insertResult.ops[0]; //find the inserted listing among listings 

      await db.users.updateOne( //and add the listing's id in user listings
        { _id: viewer._id },
        {
          $push: {
